...
def get_file():
    ...
    try:
        ...
        if updates:
            ...
            encrypted_file_path = os.path.join(updates_dir, f'{user_name}_{update_name}')
            ...
            # Changed from send_file() to manual way because of Windows problem with file removing
